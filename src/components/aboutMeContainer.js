...
const AboutMe = (props) => ( 
    <div id="aboutMe" className={aboutMeStyles.aboutMeBox}>
        <div className={aboutMeStyles.textContainer}>
            ...
            <p className={aboutMeStyles.text}>Hello! I'm Mark Moawad, a senior Computer Science student at <span className={aboutMeStyles.sbu}>Stony Brook University</span>. 
